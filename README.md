...
<table>
  <tr>
    <td width="50%" valign="top">
      <h4>:school: Eğitim</h4>
      <ul>
        <li><strong>İstanbul Beykent Üniversitesi</strong></li>
        <li>Lisans | Yönetim Bilişim Sistemleri</li>
        <li>2022 - Devam Ediyor (4. Sınıf)</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h4>:briefcase: Deneyim</h4>
      <ul>
        <li><strong>Muhasebe Stajyeri</strong> — Dem-Kar Group (2025)</li>
        <li><strong>Kasa Sorumlusu</strong> — Zincirmoda (2024 - 2025)</li>
        <li><strong>Satış Danışmanı & Kasiyer</strong> — Sateen Story (2022 - 2023)</li>
      </ul>
    </td>
  </tr>
</table>
...
*   **Kişisel Web Sitesi (HTML, CSS):** Çok sayfalı web sitesi geliştirme.
